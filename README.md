...
- [AESTETIK](https://github.com/ratschlab/aestetik) - Autoencoder for multi-modal spatial transcriptomics representation learning with morphology and topology (Bioinformatics, 2026).
